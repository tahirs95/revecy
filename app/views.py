...
def visualization(request):
    if request.method == "GET":
        ...
        return render(request, "visualization.html", {'top_rows':top_rows, 'shape':shape, 'memory':memory, 'corr_data':corr_data, 'data_types_dict_count':dict(data_types_dict_count)})
